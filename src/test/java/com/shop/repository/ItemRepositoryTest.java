...
public class ItemRepositoryTest {
    ...
    public void findByItemNmOrItemDetailTest(){
        this.createItemList();
        List<Item> itemList=
                itemRepository.findByItemNmOrItemDetail("테스트 상품4","테스트 상품 상세 설명2");
        for(Item item : itemList){
            System.out.println(item.toString());
    ...
    public void queryDslTest2(){
        ...
        Page<Item> itemPagingReault =
                itemRepository.findAll(booleanBuilder,pageable);

        System.out.println("total elements : "+
                        itemPagingReault.getTotalElements());

        List<Item> resultItemList = itemPagingReault.getContent();
